    ...
    <div style="padding:28px 36px;">
      ...
      <div style="background:#F5F3EF;border-radius:10px;padding:18px 20px;margin-bottom:24px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr style="background:#EEF2FF;">
            <td style="padding:10px 8px;font-size:14px;color:#4F46E5;font-weight:700;">Net Salary</td>
            <td style="padding:10px 8px;font-size:16px;color:#4F46E5;font-weight:800;text-align:right;">₹ ${Number(salary.net_salary).toLocaleString("en-IN")}</td>
          </tr>
        </table>
      </div>
